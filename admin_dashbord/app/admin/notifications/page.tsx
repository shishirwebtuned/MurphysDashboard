                                ...
                                {notices.map((notification) => (
                                    <TableRow key={notification._id} className="hover:bg-muted/50 transition-colors">
                                        ...
                                        <TableCell>
                                            <div className="flex items-center gap-2">
                                                <Checkbox
                                                    checked={notification.status === true}
                                                    onCheckedChange={(val) => handletogglestatus(notification._id, !notification.status)}
                                                    className="data-[state=checked]:bg-primary data-[state=checked]:border-primary"
                                                />
                                                <Badge variant={notification.status ? "default" : "secondary"} className={notification.status ? "bg-green-500/15 text-green-700 hover:bg-green-500/25 border-green-200" : "text-muted-foreground"}>
                                        ...
                                        <TableCell className="text-right">
                                            <DropdownMenu>
                                                ...
                                                <DropdownMenuContent align="end" className="w-[160px]">
                                                    ...
                                                    <DropdownMenuItem onClick={() => handletogglestatus(notification._id, !notification.status)}>
                                                        {notification.status ? (
                                                            <>
